defmodule BplateTwoWeb.UserAuthTest do
  use BplateTwoWeb.ConnCase, async: true

  alias BplateTwo.Accounts
  alias BplateTwoWeb.UserAuth
  import BplateTwo.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BplateTwoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BplateTwoWeb.Endpoint.subscribe(live_socket_id)
