defmodule BplateTwo.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, BplateTwo.Repo)
  ...
  """
  def valid_password?(%BplateTwo.Accounts.User{hashed_password: hashed_password}, password)
